...
The only strong correlation that exists in this data set is the relationship between year and the stock trade volume. There are no other strong correlations present in the data. This is apparently supported by the scatter plot of `Stock Volume vs TMAX`, with points encoded by `month` and `PRCP factor`.
