...
##Edited 12/13
#loading New York State population data from 1900 on 
...
##Edited 12/13
#Loading data on NYC shootings: number of shootings per day and number per day that are designated murders
...
For our first project, we analyzed daily weather patterns from data collected at a weather station in Central Park, New York City made available online by the National Oceanic and Atmospheric Administration. ***These data include [name variables] ***

Through our analysis, we confirmed that there was a statistically significant rise in daily maximum temperatures in Central Park over the last 122 years.  
...
We then moved on to looking at correlation and daily human activities. We found a variety of fascinating data about New York City on their website, https://opendata.cityofnewyork.us/ . 
...
#expcoeff = exp(coef(shootvt_lm))
#expcoeff

NYweathshoot_06$prdc <- exp(predict(shootvt_lm))
NYweathshoot_06$prdc

```


```{r}
#histogram of # daily NYC shootings
#ggplot(NYweathshoot_06) +
#  geom_histogram(aes(x=Shootings), na.rm=TRUE, alpha=0.5, color="black", bins=15, binwidth=1, fill = "green") + 
#  labs(title="Distribution of Number of Daily NYC Shootings (2006-2021)", x="Number of Daily Shootings", y="Count")
